...
**Sur vous lors de votre expédition** : une sacoche avec des fioles vides pour faire des mélanges (*fournie par les organisateurs*). {% hint "empty_flasks_for_alchemist" is needed %}
