...
*NOTE hors-jeu : En posant ou en faisant coulisser la feuille de détection sur des surfaces précises, vous pouvez y voir des lignes de champ magnétique, révélant soit des inscriptions, soit plus subtilement la présence de systèmes d'ouverture magnétiques.*
...
*Explications hors-jeu* : Si vous croisez une **petite pastille ronde de couleur chaude** sur un objet, cela signifie qu'il a probablement des propriétés magiques ; tandis qu'une **petite pastille ronde de couleur froide** indique simplement un objet intéressant d'un point de vue scientifique. Si vous voyez une **plume colorée**, cela peut indiquer une aura liée aux dons de prophétie.
